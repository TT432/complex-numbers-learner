  ...
  render(container) {
    container.insertAdjacentHTML('beforeend', `
      <div class="chapter">
        ...
        <div class="ch-text">
          <p>引入虚数单位（imaginary unit）$i$ 使得 $i^2 = -1$，则解为 $x = \\pm i$。</p>
        ...
        <div class="ch-text">
          <p><strong>复平面</strong>（complex plane）：横轴 = 实轴（real axis, Re），纵轴 = 虚轴（imaginary axis, Im）。每个复数 $a+bi$ 唯一对应一个平面点 $(a, b)$，反之亦然——复数和平面点之间是<strong>双射</strong>（bijection）。</p>
        </div>

        <div class="canvas-wrapper">
          <canvas id="c01-canvas"></canvas>
          <div class="canvas-label">蓝点位置 $(a, b)$ 即复数 $a+bi$</div>
        </div>
        ...
        <div class="ch-text">
          <p>与 $\\mathbb{R}^2$ 向量不同，复数定义了乘法 $i^2 = -1$，这使得它不仅是二维点，更是一个<strong>代数结构</strong>（algebraic structure）。</p>
        </div>
      </div>
    `);
